...
class TestLeadFinder(unittest.TestCase):
    def test_directory_filter(self):
        ...
        self.assertTrue(is_directory_domain("https://www.practo.com/bangalore/doctors"))
        self.assertTrue(is_directory_domain("https://www.sulekha.com/plumbing-contractors/chennai"))
        self.assertTrue(is_directory_domain("https://www.jd.com/search"))
        self.assertTrue(is_directory_domain("https://www.apollodiagnostics.in/centers"))
        self.assertTrue(is_directory_domain("https://pharmeasy.in/diagnostics"))
        self.assertTrue(is_directory_domain("https://www.1mg.com/labs/delhi"))
